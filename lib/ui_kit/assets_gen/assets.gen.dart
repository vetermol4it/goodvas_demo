...
class $AssetsIconsGen {
  ...
  /// List of all assets
  List<SvgGenImage> get values => [close, dislike, like];
}

class $AssetsImagesGen {
  const $AssetsImagesGen();

  /// File path: assets/images/slide0.png
  AssetGenImage get slide0 => const AssetGenImage('assets/images/slide0.png');
  ...
  /// List of all assets
  List<AssetGenImage> get values => [slide0, slide1, slide2, slide3, slide4];
}
